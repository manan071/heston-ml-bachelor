...
price_testC = heston_price(PutCall='C', S=100, K=100, tau=0.5, kappa=5, theta=0.05, sigma=0.5, rho=-0.8, v0=0.05, 
                r=0.03, q=0.02, trap=1, Lu=0.00001, Uu=50, du=0.001)
print(price_testC)
...
price_testC_cm = heston_call_price_cm(alpha=1.5, S=100, K=100, tau=0.5, kappa=5, theta=0.05, sigma=0.5, rho=-0.8, v0=0.05, 
                r=0.03, q=0.02, trap=1, Lu=0.00001, Uu=50, du=0.001)
...
callFFT = heston_call_FFT(N=1024, eta=0.0977, alpha=1.5, S=50, tau=0.5, kappa=0.2, theta=0.05, 
...
strikes, prices = heston_call_FFT(N=1024, eta=0.0977, alpha=1.5, S=S, tau=tau, kappa=kappa, theta=theta
...
print(heston_price(PutCall='C', S=100, K=110, tau=0.25, kappa=2.0, theta=0.08, sigma=0.3, rho=-0.5, v0=0.08, 
                      r=0.02, q=0.01, trap=1, Lu=0.00001, Uu=50, du=0.001))

print(heston_price(PutCall='C', S=100, K=90, tau=1.5, kappa=1.0, theta=0.12, sigma=0.6, rho=-0.7, v0=0.12, 
                      r=0.04, q=0.03, trap=1, Lu=0.00001, Uu=50, du=0.001))

print(heston_price(PutCall='C', S=100, K=102, tau=1.0, kappa=3.0, theta=0.10, sigma=0.4, rho=-0.6, v0=0.10, 
                      r=0.03, q=0.02, trap=1, Lu=0.00001, Uu=50, du=0.001))

print(heston_price(PutCall='C', S=100, K=100, tau=0.75, kappa=4.0, theta=0.06, sigma=0.7, rho=-0.9, v0=0.06, 
                      r=0.05, q=0.00, trap=1, Lu=0.00001, Uu=50, du=0.001))

print(heston_price(PutCall='C', S=100, K=95, tau=2.0, kappa=0.5, theta=0.15, sigma=0.2, rho=-0.3, v0=0.15, 
