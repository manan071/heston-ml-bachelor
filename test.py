...
price_testC_cm = heston_fft.heston_call_price_cm(alpha=1.5, S=100, K=100, tau=0.5, kappa=5, theta=0.05, sigma=0.5, rho=-0.8, v0=0.05, 
...
callFFT = heston_fft.heston_call_FFT(N=1024, eta=0.0977, alpha=1.5, S=50, tau=0.5, kappa=0.2, theta=0.05, sigma=0.3, rho=-0.7, v0=0.05, r=0.03, q=0.05, trap=1)
