...
def generate_data(num_samples, filename):
    with open(filename, 'w', buffering=1 << 20) as f:
        ...
        for i in range(num_samples):
            ...
            for lm, p in zip(log_moneyness[mask], prices[mask]):

                f.write(f"{lm},{tau},{kappa},{theta},{sigma},{rho},{v0},{r},{q},{p}\n")

# Main block to generate data
if __name__ == "__main__":
    generate_data(20000, "heston_data.txt") # Generate data for 20000 sets of parameters